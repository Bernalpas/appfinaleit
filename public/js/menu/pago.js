const MERCADO_PAGO = false

if(MERCADO_PAGO) {
    // Agrega credenciales de SDK
    const mercadopago = new MercadoPago("ACÁ VA LA CLAVE PÚBLICA DE MERCADO PAGO", {
        locale: "es-AR",
    });
...
function createCheckoutButton(preferenceId) {
    if(MERCADO_PAGO) {
        ...
        document.querySelector('#button-checkout').innerHTML = `
            <button style="color:white; width:100px; font-size:1.2em; border-radius:10px; padding-left:5px; padding-right:5px">Pagar</button>
        `
    }
}